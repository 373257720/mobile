...
const register = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/register')
const login = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/login')
const forgotpassword = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/forgotpassword')
const usercheck = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/usercheck')
const mysign = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/mysign')
const userpass = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/userpass')
const mhome = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/mhome')
const mine = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/mine')
const cavans = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/cavans')
const common_details = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/common_details')
const upload_contract = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/upload_contract')


// project_owner//
const p_wait_agent_input = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/wait_agent_input')
const p_check_contract = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/check_contract')
const p_investor_lists = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/investor_lists')
const p_investor_details = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/inverstor_details')
const p_sign_failed = () => import( /* webpackChunkName: "project_owner" */ '@/components/moblie/project_owner/sign_failed')
const p_sign_request = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/sign_request')
const p_wait_investor = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/wait_investor')
const p_goods_details = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/goods_details')
const p_user_contact = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/user_contact')
const p_user_contact2 = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/user_contact2')
const p_sign_successful = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/sign_successful')
const p_inverstor_details = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/inverstor_details')
const tobeSigned_roots = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/tobeSigned_roots')
const connected_projects = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/connected_projects')
const owner_roots = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/owner_set_contract/owner_roots')
const p_submit_contract = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/owner_set_contract/submit_contract')
const p_set_contract = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/owner_set_contract/set_contract')
const owner_set_contract = () => import( /* webpackChunkName: "project_owner" */
	'@/components/moblie/project_owner/owner_set_contract/owner_set_contract')
const p_sign_contract = () => import( /* webpackChunkName: "project_owner" */
...
// agent/
const a_project_intro_roots = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/agent/a_project_intro_roots')
const a_project_intro = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/project_intro')
const a_wait_review = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/wait_review')
const a_recommand_i = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/recommand_i')
const a_wait_investor_comfirm = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/agent/wait_investor_comfirm')
const a_wait_signed = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/wait_signed')
const a_sign_failed = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/sign_failed')
const a_sign_successful = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/sign_successful')
const a_wait_sendemail = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/wait_sendemail')
const a_sign_contract = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/agent/contract/sign_contract')
const recent_recommand = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/agent/recent_recommand')
...
// agent_set_contract
const a_tobeSigned_roots = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/agent/contract/tobeSigned_roots')
const a_submit_contract = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/agent/contract/submit_contract')
const a_check_contract = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/agent/contract/check_contract')
const agent_set_contract = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/agent/contract/agent_set_contract')
const uploadtoblock = () => import( /* webpackChunkName: "group-foo" */
...
const investor_roots = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/investor/investor_roots')
const i_conected_project = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/investor/conected_project')
const i_inverstor_infor = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/investor/investor_infor')
const i_perfect_infor = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/investor/perfect_infor')
const i_wait_confirm = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/investor/wait_comfirm')
const i_sign_failed = () => import( /* webpackChunkName: "group-foo" */ '@/components/moblie/investor/sign_failed')
const i_emailto_confirm = () => import( /* webpackChunkName: "group-foo" */
	'@/components/moblie/investor/emailto_confirm')
const wait_confirmRoot = () => import( /* webpackChunkName: "group-foo" */
