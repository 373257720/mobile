          ...
          <div v-if="obj.sharingMechanismType1 === 0">
            ...
            <div class="count">
              <MyNumberInput
                ...
                :max="100"
                name="projectParty"
                :isdisabled="!(obj.sharingResult == 9)"
                placeholder
...
export default {
  ...
  methods: {
    ...
    acceptOrRejectCommission(num) {
      ...
      this.$global
        .post_encapsulation(
          `${this.$axios.defaults.baseURL}/bsl_web/projectSignThree/middlemanAAcceptOrRejectCommission`,
          {
            optType: num,
    ...
    iBackGetCommissionMechanism() {
      this.$global
        .post_encapsulation(
          `${this.$axios.defaults.baseURL}/bsl_web/projectSignThree/middlemanAGetCommissionMechanismAgain`,
          {
            signId: this.$route.query.signId,
            middlemanId: this.$route.query.middlemanId,
          }
        ...
        .then((res) => {
          ...
          if (res.data.resultCode == 10000) {
            ...
            this.OriginsharingMechanism01 = res.data.data.sharingMechanism01;
            this.OriginsharingMechanism11 = res.data.data.sharingMechanism11;
